...
//  var header = config.header ? join( data.header )+newLine : '';
    ...
    if (config.footer){
        ...
        for (i = 0; i < data.footer.length; i++){
            footer = footer + join( data.footer[i] )+newLine;
        }
    }
...
//  var header = config.header ? join( data.header )+newLine : '';
	...
	for ( var i=0, ien=data.body.length ; i<ien ; i++ ) {
        ...
        console.log("BUTTONS.HTML5.JS"+footer);
...
function _excelColWidth( data, col ) {
	...
	var len, lineSplit, str;
        console.log("_excelColWith:"+col);
      //  console.log(data);
      //  console.log(data.header);
      //  console.log(data.footer);
	
        if(col>=data.footer.length){
            col--;
        }
...
DataTable.ext.buttons.excelHtml5 = {
	...
	action: function ( e, dt, button, config ) {
		...
		if ( config.footer && data.footer ) {
                    /* ----- BEGIN changed Code ----- */
		    for (i = 0; i < data.footer.length; i++){
		        addRow( data.footer[i] );
                        $('row:last c', rels).attr( 's', '2' ); // bold
                       // $('row:last c', rels).attr( 's', '52' ); // centre
		    }
		    /* ----- END changed Code ----- */
                   // console.log(rels);
