...
var _exportData = function ( dt, inOpts )
{
    ...
    var footerMatrix = getFooters( dt.settings()[0] );
...
*/
	...
	/* ----- BEGIN changed Code ----- */
      //  console.log("headerMatriz length"+headerMatrix );
        
    var columns = headerMatrix[0].length;
	//  var columns = header.length;
	/* ----- END changed Code ----- */
        //console.log( headerMatrix[headerMatrix.length - 2]+ "---"+headerMatrix );
        console.log("columnas"+ columns+"-"+ headerMatrix[0].length+" total celulas:"+cells.length);
        //console.log("columns Footer"+ footerMatrix+"-"+ footerMatrix[0].length);
	
	var rows = columns > 0 ? cells.length / (columns) : 0;
        //console.log(cells.length+"--"+columns+"---"+rows);
 ...
 * @param {type} dt
 * @returns {Array}
 * Created in 22/Aug/2017 by Belchior
 * Basead on Discussion: https://datatables.net/forums/discussion/40854/how-to-add-second-footer-to-print-in-tfoot?
 */
/* ----- BEGIN added Code ----- */
    ...
    for ( var rowIdx = 0;  rowIdx < numRows;  rowIdx++ ) {
       ...
       // console.log($row);
        ...
        for ( var colIdx = 0;  colIdx < $ths.length;  colIdx++ )
        {
            ...
            // ----- If title cell has colspan, add empty titles for extra cell width. var j=1
            for ( var j = 1;  j < colspan;  j++ ) {
                matrix[rowIdx][colCount++] = "";
            }
          
            // ----- If title cell has rowspan, add empty titles for extra cell height. var i=1
