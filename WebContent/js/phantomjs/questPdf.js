...
page.open('http://localhost:8081/Quest_Iveco/Login','POST', postBody, function(status) {
  ...
  */
  ...
  page2.open('http://localhost:8081/Quest_Iveco/index.jsp','POST', postBody, function(status) {
    ...
    setTimeout(function(){
        ...
        var x = page2.evaluate(function() {
             ...
             document.getElementById('flot-bar-chart').style.marginLeft="100px";
        ...
        // console.log(x);
  			  // era aqui
          page2.dpi=72; 
          page2.render('/Users/belchiorpalma/NetBeansProjects/Quest_Iveco/build/web/js/phantomjs/q.pdf', {format: 'pdf', pool: 1,paperFormat : 'A4'});
