            ...
            <div class="col-md-12">
                <div class="ibox-content" style="float:left;background-color: #ffffff;color: inherit;padding: 15px 20px 20px 20px;border-color: #e7eaec;border-image: none;border-style: solid solid none;border-width: 0px 0px;">
                    ...
                    <p class="header-marron"  style="background-color: #ebd9c0;min-width: 300px;min-height: 50px;margin:10px -20px 10px -20px;padding: 20px 20px 40px 40px;font-family: Georgia;font-size:14px;color:#898989;font-weight: bold;text-align: center;">
                        <%if(e!=null &&  e.getEmailMktId()>0){out.print(Utils.blobToString(e.getDescription()));}%>
                                ...
                                <div class="ibox">
                                    <div class="ibox-content"  style="float:left;background-color: #ffffff;color: inherit;padding: 15px 20px 20px 20px;border-color: #e7eaec;border-image: none;border-style: solid solid none;border-width: 0px 0px;">
                                        ...
                                        <div class="form-group">
                                            <select name="clientId" id="clientId" onChange="document.forms[0].submit()">
                                                <%
                                            ...
                                            <input type="text" class="form-control" placeholder="Name" required="" name="name" value="<%=name%>"  style="margin-top: 10px;width: 98%;height: 34px;padding: 6px 12px;background-color: #fff;border: 1px solid #ccc;border-radius: 4px;-webkit-box-shadow: inset 0 1px 1px rgba(0, 0, 0, .075);box-shadow: inset 0 1px 1px rgba(0, 0, 0, .075);-webkit-transition: border-color ease-in-out .15s, -webkit-box-shadow ease-in-out .15s;-o-transition: border-color ease-in-out .15s, box-shadow ease-in-out .15s;transition: border-color ease-in-out .15s, box-shadow ease-in-out .15s">
                                            <input type="email" class="form-control" placeholder="Email address" required="" name="email" value="<%=email%>"  style="margin-top: 10px;width: 98%;height: 34px;padding: 6px 12px;background-color: #fff;border: 1px solid #ccc;border-radius: 4px;-webkit-box-shadow: inset 0 1px 1px rgba(0, 0, 0, .075);box-shadow: inset 0 1px 1px rgba(0, 0, 0, .075);-webkit-transition: border-color ease-in-out .15s, -webkit-box-shadow ease-in-out .15s;-o-transition: border-color ease-in-out .15s, box-shadow ease-in-out .15s;transition: border-color ease-in-out .15s, box-shadow ease-in-out .15s">
                                            <input type="text" class="form-control" placeholder="Address" required="" name="address" value="<%=address%>"  style="margin-top: 10px;width: 98%;height: 34px;padding: 6px 12px;background-color: #fff;border: 1px solid #ccc;border-radius: 4px;-webkit-box-shadow: inset 0 1px 1px rgba(0, 0, 0, .075);box-shadow: inset 0 1px 1px rgba(0, 0, 0, .075);-webkit-transition: border-color ease-in-out .15s, -webkit-box-shadow ease-in-out .15s;-o-transition: border-color ease-in-out .15s, box-shadow ease-in-out .15s;transition: border-color ease-in-out .15s, box-shadow ease-in-out .15s">
                                            
                                            <!-- hidden fields -->
                                            <input type="hidden" name="message" id="message"/>
                                            <input type="hidden" name="send" id="send" value="send"/>
                                            <input type="hidden" name="client" id="client" value="<%=clientId%>"/>
                                            <input type="hidden" name="id" id="id" value="<%=emailMktId%>"
                                        </div>
                                        
                                        
                                        <h3><br/>Your Selection</h3>
                                        ...
                                        <ul id="area_disponivel" class="sortable-list connectList agile-list"  style=" padding:0;">
                                             ...
                                             <li class="emailmkt-element" id="<%=p.getProductId()%>"  style="float:left;width:98%;border-left: 3px solid #B3A9A9;background: #FAFAFB;border: 1px solid #e7eaec;margin: 0px 0 10px 0;padding: 10px;border-radius: 2px;font-size:12px;list-style:none;">
                                                ...
                                                <div class="col-lg-10" style="float:left;min-width: 300px; width:300px;min-height: 100px;">
                                                    <h2><%=p.getName()%></h2>
                                                    <h3>AU$ <%=p.getPrice()%> per unit or AU$ <%=p.getPrice()*6%> per 6 bottles</h3>
                                                    <div class="agile-detail">

                                                        <!--
                                                        <a href="#" class="pull-right btn btn-xs btn-white click_area" onclick="cadastrarAreaOperacional('1','Belchior','belchiorpalma@gmail.com')">&#8594;</a>
                                                        -->
                                                        <!--<a href="#" class="pull-right btn btn-xs btn-white">ID 1</a> -->
                                                        <!--
                                                        <a  class="pull-right btn btn-xs btn-white" >
                                                         <select name="quantity_<%=p.getProductId()%>" placeholder="Quantity" onChange="calcSubTotal('<%=p.getProductId()%>','<%=p.getPrice()%>')">
                                            ...
                                            %>
                                          <!--
                                            <li class="emailmkt-element" id="1">
                                                <img src="" class="emailMktImage"/>
                                                <h2>Petit Castel</h2>
                                                <h3>AU$112 per unit or AU$ 100 per 6 bottles</h3>
                                                <div class="agile-detail">
                                          ...
                                          <div id="result" style="width:100%;height:100px;float:left;">
                                              <div style="float:right;font-size:16px;">AU$ </div>
                                              <div style="float:right;font-size:16px;" id="subTotal"></div>
                                          </div>  
                                          -->
                                    </div>
                                </div>
                                <button id="btn_submit"  type="button" class="btn btn-primary block full-width m-b" onclick="sendEmail()" style="height:35px;width:100%;">SEND EMAIL MARKETING</button>
